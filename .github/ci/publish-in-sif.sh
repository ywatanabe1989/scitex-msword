...
# (project=scitex-msword, owner=ywatanabe1989, repo=scitex-msword,
...
TMPDIR="/tmp/publish-scitex_msword-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-msword dist/* uploaded to PyPI via manual OIDC trusted publishing"
